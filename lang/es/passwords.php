...
return [
    ...
    | coinciden con las razones dadas por el broker de contraseñas para
    | un intento de actualización de contraseña, como fallo debido a una
    | contraseña no válida o un token de restablecimiento no válido.
    |
    */
