...
return [
    ...
    | Puede modificar cada uno de estos mensajes aquí.
    |
    */
    ...
    | líneas. Esto permite especificar rápidamente una línea de idioma
    ...
    */
    ...
    | marcador de posición de atributo con algo más legible, como
